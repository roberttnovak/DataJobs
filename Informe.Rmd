  ...
  mutate(
    ...
    Revenue=
           case_when(
             ...
             Revenue=="$10+ billion (USD)"               ~ "10000000000-",
         )
         
) %>% 
  separate(Revenue, sep="-", into=c("Revenue Inf","Revenue Sup")) %>% View
